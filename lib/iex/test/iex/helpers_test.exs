...
defmodule IEx.HelpersTest do
  ...
  describe "open" do
    ...
    test "opens Elixir module" do
      assert capture_iex("open(IEx.Helpers)") =~ ~r/#{@iex_helpers}:1/
    end

    test "opens function" do
      assert capture_iex("open(h)") =~ ~r/#{@iex_helpers}:\d+/
    end

    test "opens function/arity" do
      assert capture_iex("open(b/1)") =~ ~r/#{@iex_helpers}:\d+/
      assert capture_iex("open(h/0)") =~ ~r/#{@iex_helpers}:\d+/
    end

    test "opens module.function" do
      assert capture_iex("open(IEx.Helpers.b)") =~ ~r/#{@iex_helpers}:\d+/
      assert capture_iex("open(IEx.Helpers.h)") =~ ~r/#{@iex_helpers}:\d+/
    end

    test "opens module.function/arity" do
      assert capture_iex("open(IEx.Helpers.b/1)") =~ ~r/#{@iex_helpers}:\d+/
      assert capture_iex("open(IEx.Helpers.h/0)") =~ ~r/#{@iex_helpers}:\d+/
    end

    test "opens Erlang module" do
      assert capture_iex("open(:elixir)") =~ ~r/#{@elixir_erl}:\d+/
    end

    test "opens Erlang module.function" do
      assert capture_iex("open(:elixir.start)") =~ ~r/#{@elixir_erl}:\d+/
    end

    test "opens Erlang module.function/arity" do
      assert capture_iex("open(:elixir.start/2)") =~ ~r/#{@elixir_erl}:\d+/
    end
    ...
    test "opens the current pry location" do
      assert capture_iex("open()", [], env: %{__ENV__ | line: 3}) ==
             "#{__ENV__.file}:3"
    end
    ...
    test "opens given {file, line}" do
      assert capture_iex("open({#{inspect __ENV__.file}, 3})") ==
             "#{__ENV__.file}:3"
    end
    ...
    test "opens given path" do
      assert capture_iex("open(#{inspect __ENV__.file})") ==
             __ENV__.file
    end
  end
